...
define('app',['jquery', 'swiper', 'swiperJquery', 'swiperUmd', 'modules/lazyLoad', 'modules/map', 'modules/script'], function($, Swiper, swiperJquery, swiperUmd, lazyLoad, map, script) {
