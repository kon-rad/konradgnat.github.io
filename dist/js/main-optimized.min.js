...
define('modules/lazyLoad',['jquery', 'intersectionObserver', 'modernizr'], function($) {
...
define('modules/map',['async!https://maps.googleapis.com/maps/api/js?key=AIzaSyA8UtfbT1GSWWG1kmpmwZZ_9xtCnw9zXXg&callback=initMap'], function() {
'use strict';
  function initMap() {
...
define('app',['jquery', 'swiper', 'swiperJquery', 'swiperUmd', 'modules/lazyLoad', 'modules/map'], function($, Swiper, swiperJquery, swiperUmd, lazyLoad, map) {
...
define('modules/script',['jquery'], function($) {
...
define('mainSlider',['swiper', 'swiperUmd', 'swiperJquery'], function(Swiper) {
...
define('modules/quotes',['jquery', 'mainSlider'], function($, mainSlider) {
